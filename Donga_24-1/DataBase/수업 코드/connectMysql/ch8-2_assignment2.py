...
def insertData():
    ...
    data5 = None if not edt5.get() else edt5.get()
    data6 = None if not edt6.get() else edt6.get()
    data7 = None if not edt7.get() else edt7.get()
    data8 = None if not edt8.get() else edt8.get()
...
def selectData():
    ...
    while (True):
        ...
        strData5.append('-' if row[4] is None else row[4])
        strData6.append('-' if row[5] is None else row[5])
        strData7.append('-' if row[6] is None else row[6])
        strData8.append('-' if row[7] is None else row[7])
    ...
    for item1, item2, item3, item4, item5, item6, item7, item8 in (
            zip(strData1, strData2, strData3, strData4, strData5, strData6, strData7, strData8)):
